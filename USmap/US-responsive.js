...
$(".state").mouseover(function(e){
	...
	if (this.id == data[i][0]) {
$("#timeline").append('<div class="hoverbox" style="top:'+they+'px; left:'+thex+'px;"><div class="statename">'+data[i][1]+'</div><div class="statepct1">'+ "Positive Tweets : " + data[i][2]+ "%" + '</div><div class="statepct1">'+ "Negative Tweets: " + data[i][3]+ "%" +'</div><div class="statepct1">'+ "Top Topics: " + data[i][4]+ '</div></div>');
	} 
